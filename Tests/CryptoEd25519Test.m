...
-(void) testAll {
    ...
    NSString * writePrivatePemFile = [[NSString alloc] initWithFormat:@"%@writePrivate1.pem",CRYPTO_PATH_ED25519];
    ...
    NSString * writePublicPemFile = [[NSString alloc] initWithFormat:@"%@writePublic1.pem",CRYPTO_PATH_ED25519];
