...
-(void) testDeployApprovalSerialization {
    ...
    NSString * listASerialization = [DeploySerialize serializeForDeployApproval:listApprovals];
    NSLog(@"listASerialization:%@",listASerialization);
    ...
    NSString * listASerialization2 = [DeploySerialize serializeForDeployApproval:listApprovals2];
    NSLog(@"listASerialization2:%@",listASerialization2);
...
- (void) testDeploySerialization {
    ...
    NSString * deploySerialization = [DeploySerialize serializeForDeploy:deploy];
...
-(void) testDeployHeaderSerialization {
    ...
    [dh.dependencies addObject:@"0101010101010101010101010101010101010101010101010101010101010101"];
    dh.chain_name = @"casper-example";
    NSString * headerSerialization = [DeploySerialize serializeForHeader:dh];
