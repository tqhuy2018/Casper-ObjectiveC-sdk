...
#import <CasperSDKObjectiveC/GetDictionaryItemRPC.h>
#import <CasperSDKObjectiveC/ConstValues.h>
#import <CasperSDKObjectiveC/GetDictionaryItemResult.h>
@implementation GetDictionaryItemRPC
    ...
    NSURLSessionDataTask *task = [session dataTaskWithRequest:request completionHandler:^(NSData * _Nullable data, NSURLResponse * _Nullable response, NSError * _Nullable error) {
        ...
        if(httpResponse.statusCode == 200)
        {
            ...
            if(cem.message == CASPER_ERROR_MESSAGE_NONE) {
                ...
                item = [GetDictionaryItemResult fromJsonDictToGetItemResult:forJSONObject[@"result"]];
