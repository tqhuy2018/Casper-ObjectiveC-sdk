...
//VALUES FOR GETTING RPC OBJECT
// VALUE FOR NONE SET VALUE OBJECT
FOUNDATION_EXPORT NSString *const VALUE_NOT_SET;
// VALUE FOR GETTING OBJECT ERROR
FOUNDATION_EXPORT NSString *const VALUE_ERROR_RPC_OBJECT;
// VALUE FOR URL OR NETWORK ERROR
FOUNDATION_EXPORT NSString *const VALUE_ERROR_RPC_NETWORK;
#endif
