...
// VALUE FOR NONE SET VALUE OBJECT
NSString *const VALUE_NOT_SET = @"VALUE_NOT_SET";
// VALUE FOR GETTING OBJECT ERROR
NSString *const VALUE_ERROR_RPC_OBJECT = @"ERROR_GETTING_RPC_OBJECT";
// VALUE FOR URL OR NETWORK ERROR
NSString *const VALUE_ERROR_RPC_NETWORK = @"ERROR_GETTING_RPC_NETWORK";
