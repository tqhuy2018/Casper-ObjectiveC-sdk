#ifndef GetBlockTransfersRPC_h
#define GetBlockTransfersRPC_h
#import <Foundation/Foundation.h>
@interface GetBlockTransfersRPC : NSObject
...
/// This dictionary object hold the value of the GetBlockTransfersResult when call the RPC, it is used when you call the RPC from other package or other project.
