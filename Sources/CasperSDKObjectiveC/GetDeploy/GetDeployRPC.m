...
#import <CasperSDKObjectiveC/GetDeployRPC.h>
#import <CasperSDKObjectiveC/ConstValues.h>
#import <CasperSDKObjectiveC/GetDeployResult.h>
@implementation GetDeployRPC
    ...
    NSURLSessionDataTask *task = [session dataTaskWithRequest:request completionHandler:^(NSData * _Nullable data, NSURLResponse * _Nullable response, NSError * _Nullable error) {
        ...
        if(httpResponse.statusCode == 200)
        {
            ...
            if(cem.message == CASPER_ERROR_MESSAGE_NONE) {
                ...
                GetDeployResult * item = [[GetDeployResult alloc] init];
                item = [GetDeployResult fromJsonDictToGetDeployResult:forJSONObject[@"result"]];
