...
#import <CasperSDKObjectiveC/GetBlockRPC.h>
#import <CasperSDKObjectiveC/ConstValues.h>
#import <CasperSDKObjectiveC/GetBlockResult.h>
@implementation GetBlockRPC
    ...
    NSURLSessionDataTask *task = [session dataTaskWithRequest:request completionHandler:^(NSData * _Nullable data, NSURLResponse * _Nullable response, NSError * _Nullable error) {
        ...
        if(httpResponse.statusCode == 200)
        {
            ...
            if(cem.message == CASPER_ERROR_MESSAGE_NONE) {
                ...
                GetBlockResult * item = [[GetBlockResult alloc] init];
                item = [GetBlockResult fromJsonDictToGetBlockResult:forJSONObject[@"result"]];
