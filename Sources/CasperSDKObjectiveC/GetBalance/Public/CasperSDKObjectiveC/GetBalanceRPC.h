#ifndef GetBalanceRPC_h
#define GetBalanceRPC_h
#import <Foundation/Foundation.h>
@interface GetBalanceRPC:NSObject
...
/// This dictionary object hold the value of the GetBalanceResult when call the RPC, it is used when you call the RPC from other package or other project.
...
-(void) getBalanceResultWithJsonParam:(NSString*) jsonString;
-(void) getBalanceResultWithJsonParam2:(NSString*) jsonString andCallID:(NSString*) callID;
@end
#endif
