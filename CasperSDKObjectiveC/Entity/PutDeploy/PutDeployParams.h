#ifndef PutDeployParams_h
#define PutDeployParams_h

/**Class built for storing PutDeployParams information, used for sending account_put_deploy RPC method
 */
#import "Deploy.h"
//@class Ed25519Handle;
@interface PutDeployParams:NSObject
@property Deploy * deploy;
//- (Ed25519Handle *)returnSwiftClassInstance;
